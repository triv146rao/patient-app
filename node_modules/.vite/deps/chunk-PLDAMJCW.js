...
async function ce(r, e, t) {
  ...
  (Hr.includes(e.type) || (a2 == null ? void 0 : a2.endsWith(".tgz")) || (a2 == null ? void 0 : a2.endsWith(".tar.gz"))) && (s2 = await ar(s2));
  let o;
  try {
    o = (0, g2.untar)(s2);
  } catch (i2) {
...
async function Wr(r) {
  let { promisify: e } = await import("./util-LKQBIVID.js"), { gzip: t } = await import("./zlib-OQY22ONI.js");
  return await e(t)(r);
}
async function ar(r) {
...
async function Kr(r) {
  let { promisify: e } = await import("./util-LKQBIVID.js"), { gunzip: t } = await import("./zlib-OQY22ONI.js");
  return await e(t)(r);
}
function sr(r) {
...
var Zr = (r, e) => {
  let t = r.FS, s2 = e.debug ? console.log : null, a2 = { tryFSOperation(n2) {
    ...
    s2 == null ? void 0 : s2("setattr", a2.realPath(n2), o);
    ...
    s2 == null ? void 0 : s2("lookup", a2.realPath(n2), o);
    let i2 = [a2.realPath(n2), o].join("/"), u2 = a2.getMode(i2);
    return a2.createNode(n2, o, u2);
  }, mknod(n2, o, i2, u2) {
    s2 == null ? void 0 : s2("mknod", a2.realPath(n2), o, i2, u2);
    ...
    s2 == null ? void 0 : s2("rename", a2.realPath(n2), a2.realPath(o), i2);
    let u2 = a2.realPath(n2), c2 = [a2.realPath(o), i2].join("/");
    a2.tryFSOperation(() => {
      e.rename(u2, c2);
    }), n2.name = i2;
  }, unlink(n2, o) {
    s2 == null ? void 0 : s2("unlink", a2.realPath(n2), o);
    ...
    s2 == null ? void 0 : s2("rmdir", a2.realPath(n2), o);
    let i2 = [a2.realPath(n2), o].join("/");
    return a2.tryFSOperation(() => {
      e.rmdir(i2);
    });
  }, readdir(n2) {
    s2 == null ? void 0 : s2("readdir", a2.realPath(n2));
    let o = a2.realPath(n2);
    return a2.tryFSOperation(() => e.readdir(o));
  }, symlink(n2, o, i2) {
    throw s2 == null ? void 0 : s2("symlink", a2.realPath(n2), o, i2), new t.ErrnoError(63);
  }, readlink(n2) {
    throw s2 == null ? void 0 : s2("readlink", a2.realPath(n2)), new t.ErrnoError(63);
  } }, stream_ops: { open(n2) {
    s2 == null ? void 0 : s2("open stream", a2.realPath(n2.node));
    let o = a2.realPath(n2.node);
    return a2.tryFSOperation(() => {
      t.isFile(n2.node.mode) && (n2.shared.refcount = 1, n2.nfd = e.open(o));
    });
  }, close(n2) {
    return s2 == null ? void 0 : s2("close stream", a2.realPath(n2.node)), a2.tryFSOperation(() => {
      t.isFile(n2.node.mode) && n2.nfd && --n2.shared.refcount === 0 && e.close(n2.nfd);
    });
  }, dup(n2) {
    s2 == null ? void 0 : s2("dup stream", a2.realPath(n2.node)), n2.shared.refcount++;
  }, read(n2, o, i2, u2, c2) {
    return s2 == null ? void 0 : s2("read stream", a2.realPath(n2.node), i2, u2, c2), u2 === 0 ? 0 : a2.tryFSOperation(() => e.read(n2.nfd, o, i2, u2, c2));
  }, write(n2, o, i2, u2, c2) {
    return s2 == null ? void 0 : s2("write stream", a2.realPath(n2.node), i2, u2, c2), a2.tryFSOperation(() => e.write(n2.nfd, o.buffer, i2, u2, c2));
  }, llseek(n2, o, i2) {
    s2 == null ? void 0 : s2("llseek stream", a2.realPath(n2.node), o, i2);
    let u2 = o;
    ...
    if (s2 == null ? void 0 : s2("mmap stream", a2.realPath(n2.node), o, i2, u2, c2), !t.isFile(n2.node.mode)) throw new t.ErrnoError(pr.ENODEV);
    let m = r.mmapAlloc(o);
    return a2.stream_ops.read(n2, r.HEAP8, m, o, i2), { ptr: m, allocated: true };
  }, msync(n2, o, i2, u2, c2) {
    return s2 == null ? void 0 : s2("msync stream", a2.realPath(n2.node), i2, u2, c2), a2.stream_ops.write(n2, o, 0, u2, i2), 0;
  } } };
  return a2;
};
...
//# sourceMappingURL=chunk-PLDAMJCW.js.map
