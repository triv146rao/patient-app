...
var L = class extends cr {
  ...
  async maintainPool(e) {
    ...
    for (let i = 0; i > t; i--) o.push(new Promise(async (c) => {
      ...
      (_a = h(this, m).get(a)) == null ? void 0 : _a.close(), await h(this, F).removeEntry(h2.name), h(this, b).delete(a), h(this, m).delete(a), c();
    }));
    await Promise.all(o);
  }
  ...
  _mkdirState(e, t) {
    ...
    for (let d of o) {
      if (c.push(e), !Object.prototype.hasOwnProperty.call(a.children, d)) if (t == null ? void 0 : t.recursive) this.mkdir(c.join("/"));
    ...
    let h2 = { type: "directory", lastModified: Date.now(), mode: (t == null ? void 0 : t.mode) || T2.DIR, children: {} };
    a.children[i] = h2;
  }
  open(e, t, o) {
  ...
  _unlinkState(e, t = false) {
    ...
    if (delete c.children[i], t) {
      ...
      h2 == null ? void 0 : h2.truncate(0), h(this, S).add(h2), h(this, D).has(e) && (h(this, P).delete(h(this, D).get(e)), h(this, D).delete(e));
    }
  ...
  writeFile(e, t, o) {
    ...
    if (Object.prototype.hasOwnProperty.call(a.children, c)) {
      ...
      let l = { type: "file", lastModified: Date.now(), mode: (o == null ? void 0 : o.mode) || T2.FILE, backingFilename: this.state.pool.pop() };
...
${t}`), i = h(this, y).getSize();
  ...
  let o = T(this, n, w).call(this, e), i = (t == null ? void 0 : t.from) || h(this, H);
  for (let c of o) i = await i.getDirectoryHandle(c, { create: t == null ? void 0 : t.create });
  return i;
};
...
//# sourceMappingURL=opfs-ahp-N35PJPMA.js.map
