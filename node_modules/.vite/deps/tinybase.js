...
var mapKeys = (map) => [...(map == null ? void 0 : map.keys()) ?? []];
...
var DECODE = mapNew(
  arrayMap(ENCODE, (char, index) => [char, index])
);
...
var getAggregateValue = (aggregateValue, oldLength, newValues, changedValues, aggregators, force = false) => {
  ...
  collForEach(changedValues, ([oldValue, newValue]) => {
    if (!force) {
      aggregateValue = isUndefined(oldValue) ? aggregateAdd == null ? void 0 : aggregateAdd(aggregateValue, newValue, oldLength++) : isUndefined(newValue) ? aggregateRemove == null ? void 0 : aggregateRemove(aggregateValue, oldValue, oldLength--) : aggregateReplace == null ? void 0 : aggregateReplace(aggregateValue, newValue, oldValue, oldLength);
      force || (force = isUndefined(aggregateValue));
    }
  });
      ...
      const getTableCell = (arg1, arg2) => {
        ...
        return store.getCell(
          ...isUndefined(arg2) ? [tableId, rootRowId, arg1] : arg1 === tableId ? [tableId, rootRowId, arg2] : [
            ...
            (_c = mapGet((_b = mapGet(joins, arg1)) == null ? void 0 : _b[4], rootRowId)) == null ? void 0 : _c[0],
            arg2
          ]
        );
      };
...
var createRelationships = getCreateFunction((store) => {
  ...
  const getRemoteRowId = (relationshipId, localRowId) => {
    var _a;
    return mapGet((_a = getRelationship(relationshipId)) == null ? void 0 : _a[0], localRowId);
  };
  const getLocalRowIds = (relationshipId, remoteRowId) => {
    var _a;
    return collValues(mapGet((_a = getRelationship(relationshipId)) == null ? void 0 : _a[1], remoteRowId));
  };
...
//# sourceMappingURL=tinybase.js.map
