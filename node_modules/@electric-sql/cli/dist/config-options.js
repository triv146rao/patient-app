...
const configOptions = {
  ...
  PROXY: {
    ...
    constructedDefault: "postgresql://postgres:{ELECTRIC_PG_PROXY_PASSWORD}@{ELECTRIC_PG_PROXY_HOST}:{ELECTRIC_PG_PROXY_PORT}/{ELECTRIC_DATABASE_NAME}"
  },
  CLIENT_PATH: {
    valueType: String,
    valueTypeName: "path",
  ...
  SERVICE_HOST: {
    ...
    groups: ["client", "proxy"],
    inferVal: (options) => inferServiceUrlPart("host", options),
  ...
  PG_PROXY_HOST: {
    ...
    `,
    groups: ["client", "proxy"],
    inferVal: (options) => inferProxyUrlPart("host", options),
    defaultVal: (options) => getConfigValue("SERVICE_HOST", options).toString()
  },
  MODULE_RESOLUTION: {
    valueType: String,
  ...
  DATABASE_URL: {
    ...
    constructedDefault: "postgresql://{ELECTRIC_DATABASE_USER}:{ELECTRIC_DATABASE_PASSWORD}@{ELECTRIC_DATABASE_HOST}:{ELECTRIC_DATABASE_PORT}/{ELECTRIC_DATABASE_NAME}",
    groups: ["database", "electric"]
  },
  DATABASE_HOST: {
    doc: "Hostname of the database server.",
    valueType: String,
    inferVal: (options) => inferDbUrlPart("host", options),
    defaultVal: "localhost",
    groups: ["database"]
  },
  DATABASE_PORT: {
    ...
    valueType: Number,
    inferVal: (options) => inferDbUrlPart("port", options, 5432),
    defaultVal: 5432,
    groups: ["database"]
  },
  DATABASE_USER: {
    ...
    valueType: String,
    inferVal: (options) => inferDbUrlPart("user", options),
    defaultVal: "postgres",
    groups: ["database"]
  },
  DATABASE_PASSWORD: {
    ...
    valueType: String,
    inferVal: (options) => inferDbUrlPart("password", options),
  ...
  DATABASE_NAME: {
    ...
    valueType: String,
    inferVal: (options) => inferDbUrlPart("dbName", options, inferProxyUrlPart("dbName", options)),
  ...
  HTTP_PORT: {
    inferVal: (options) => inferServiceUrlPart("port", options),
    defaultVal: "5133",
    valueType: Number,
    valueTypeName: "port",
    doc: dedent`
  ...
  PG_PROXY_PORT: {
    inferVal: (options) => inferProxyUrlPart("port", options, 65432)?.toString(),
    defaultVal: "65432",
    valueType: String,
    valueTypeName: "port",
  ...
  PG_PROXY_PASSWORD: {
    inferVal: (options) => inferProxyUrlPart("password", options),
  ...
  ELECTRIC_IMAGE: {
    valueType: String,
    valueTypeName: "image",
    defaultVal: `electricsql/electric:${isCanaryRelease() ? "canary" : LIB_MINOR_VERSION}`,
